  ...
  /**
     ...
     expect the Throwable <code>t</code>, to be in the format
       ...
       <pre>
        java.lang.Throwable
        ...
          at PatternLayout.format(PatternLayout.java:413)
          at FileAppender.doAppend(FileAppender.java:183)
        at Category.callAppenders(Category.java:131)
        at Category.log(Category.java:512)
