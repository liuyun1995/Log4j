...
/**
 * @Package org.apache.log4j
 * @ClassName: org.apache.log4j.WriterAppender  
 * @author 张明明  braveheart1115@163.com
 * @date 2016年5月9日 下午3:15:07
 * @Description:
 * WriterAppender引入了三个字段：immediateFlush，指定没写完一条日志后，即将日志内容刷新到设备中，
 * 虽然这么做会有一点性能上的损失，但是如果不怎么做，则会出现在程序异常终止的时候无法看到部分日志信息，
 * 而经常这些丢失的日志信息要用于分析为什么会出现异常终止的情况，因而一般推荐将该值设置为true，即默认值；
 * 
...
public class WriterAppender extends AppenderSkeleton {
  ...
  /**
     Immediate flush means that the underlying(优先的) writer or output stream
