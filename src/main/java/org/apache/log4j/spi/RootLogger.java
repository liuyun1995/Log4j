...
public final class RootLogger extends Logger {
  /**
     The root logger names itself as "root". However, the root logger cannot be retrieved恢复 by name.
  */
  ...
  /**
     Return the assigned指定的 level value without walking the logger hierarchy.
  */
  ...
  /**
     Setting a null value to the level of the root logger may have catastrophic(灾难的)results. 
     We prevent(阻止) this here.
     @since 0.8.3 */
